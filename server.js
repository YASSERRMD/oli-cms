    ...
    res.json({
        ...
        endpoints: {
            ...
            pages: {
                ...
                sections: 'POST /api/pages/:id/sections',
                export: 'GET /api/pages/:id/export',
                import: 'POST /api/pages/import',
                backup: 'GET /api/pages/backup/all',
                restore: 'POST /api/pages/restore'
            },
            upload: {
                single: 'POST /api/upload',
                multiple: 'POST /api/upload/multiple',
                list: 'GET /api/upload/:pageId',
                delete: 'DELETE /api/upload/:pageId/:filename',
                stats: 'GET /api/upload/stats/:pageId'
            },
            generators: {
                list: 'GET /api/generators',
                get: 'GET /api/generators/:id',
                generate: 'POST /api/generators/:id/generate',
                register: 'POST /api/generators/custom/register',
                preview: 'GET /api/generators/:id/preview'
            }
        }
    });
});
